                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Poster</label>
                            <input type="file" class="form-control" id="editGambar" name="gambar" placeholder="ex: gambar" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                      ...
                      <div class="row mt-2">
                        <div class="col-md-12">
                          ...
                          <textarea name="description" id="editDescription" cols="55" rows="10"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
